...
const journey = [
  ...
  },
  {
    ...
    year: '2025 - 2026',
    title: 'CEO',
    organization: 'BLUELAB TECHNOLOGIES',
    description: 'Leading digital product engineering, modern full-stack web platforms, scalable cloud architectures, and guiding end-to-end software solutions.',
  },
  {
    id: '03',
    year: '2024',
    ...
    description: 'Engineered high-performance responsive web interfaces with React, optimized client-side rendering pipelines, and collaborated within development teams.',
  },
  {
    id: '04',
    year: '2023 - PRESENT',
    title: 'B.E. IN COMPUTER SCIENCE',
    organization: 'SRI KRISHNA COLLEGE OF ENGG & TECH',
    description: 'Specializing in scalable full-stack development, cloud computing, and software engineering. Building industry-grade web products with clean architectures.',
  },
  {
    id: '05',
    year: '2019 - 2023',
    title: 'HIGHER SECONDARY EDUCATION',
    organization: 'VEVEAHAM HR SEC SCHOOL',
    description: 'Completed secondary and higher secondary education with specialization in Computer Science, Mathematics, and Physics with academic excellence.',
  },
];
...
export default function ExperienceSection() {
  ...
  return (
    <section
      id="experience"
      ref={containerRef}
      className="relative z-20 w-full bg-black text-[#E8DFD8] font-sans selection:bg-[#cbb59d] selection:text-black pt-16 pb-28 px-6 sm:px-12 lg:px-20 overflow-hidden"
    >
