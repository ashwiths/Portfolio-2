...
import ashilImg from '../assets/ashil.jpeg';
...
export default function AboutSection() {
  ...
  // 1. Motion Values for 3D card tilt & spotlight
  ...
  return (
    ...
    >
      ...
      <div className="hidden lg:block absolute left-8 top-1/2 -translate-y-1/2 w-2 h-2 rounded-full bg-[#E5C384]/80 shadow-[0_0_10px_#D4AF37] pointer-events-none z-20" />
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            {/* Specializations & Roles Tagline */}
            <motion.div
              variants={fadeUpVariants}
              className="flex items-center gap-2 mb-6 select-none flex-wrap"
            >
              <p
                className="text-xs sm:text-[13px] md:text-sm font-medium tracking-[0.22em] sm:tracking-[0.28em] md:tracking-[0.32em] uppercase text-[#EAD8C7]/90"
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                FULL STACK DEVELOPER <span className="text-[#D4AF37] mx-1 sm:mx-2 font-light">·</span> DATA SCIENCE
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <span
                  className="text-[10px] font-medium tracking-[0.22em] uppercase text-[#A8988B] mt-0.5"
                  style={{ fontFamily: "'Montserrat', sans-serif" }}
                >
                  B.E CGPA
                </span>
              ...
              <div className="flex flex-col">
                ...
                <span
                  className="text-[10px] font-medium tracking-[0.22em] uppercase text-[#A8988B] mt-0.5 leading-[1.35]"
                  style={{ fontFamily: "'Montserrat', sans-serif" }}
                >
