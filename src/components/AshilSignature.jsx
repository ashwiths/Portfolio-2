 ...
 * • Pure handwritten vector strokes: natural handwriting flow with curves and pauses.
 ...
 *
 * Timing:
 * • Write Sequence: ~2.75s (natural handwriting flow)
...
export default function AshilSignature({
  className = '',
  color = '#F2D8A7',
  glowColor = '#D4AF37',
  strokeWidth = 1.6,
  ...
  return (
    ...
    >
      ...
      >
        <defs>
          <filter id="sig-glow-gold" x="-30%" y="-30%" width="160%" height="160%">
